...
При старте нового проекта Цэпик загружает `userPreferences`, `savedInstructions` и сохранённые организации в системный контекст проекта. Если пользователь вводит название организации, Цэпик ищет её в памяти и подставляет сохранённые адрес, руководителя, ОКВЭД и типовые отходы.
