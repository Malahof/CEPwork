...
Нажмите кнопку экспорта в панели предпросмотра, чтобы скачать текущую страницу в нужном формате.

Экспортированный файл включает:
- Полностью оформленный HTML
- Встроенные стили
- Подсветку синтаксиса кода
- DOCX-документ для редактирования
- XLSX-таблицу со структурой Markdown
